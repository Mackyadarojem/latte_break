$(document).ready(function () {
    ...
    if(role_id == 1){
         features = [
           ...
           { name: 'Item Management', link: '/itemList' },
           { name: 'Archive Item List', link: '/archiveItemList' },
           { name: 'Product Management', link: '/productList' },
           { name: 'Account Management', link: '/accountList' },
           { name: 'Event Management', link: '/event_management' },
